                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                                            <ul>
                                                                @foreach ($categorieswomen as $women )
                                                                    <li><a class="dropdown-item nav-link nav_item" href="#">{{ $women->name }}</a></li>
                                                                @endforeach
                                                ...
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                @foreach ($categoriesmen as $men )
                                                                    <li><a class="dropdown-item nav-link nav_item" href="#">{{ $men->name }}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </li>
